...
const App: React.FC = () => {
  ...
  return (
    // Updated background color to #E3E8EB
    <div className="min-h-screen flex flex-col bg-[#E3E8EB] text-slate-900 font-sans">
      
      {/* Header */}
      <header className="bg-[#E3E8EB] sticky top-0 z-30 h-14 flex items-center justify-center border-b border-[#A3D5DC]/30">
        <div className="w-full max-w-2xl px-4 flex items-center justify-between relative">
          ...
          <div className="w-8">
            {selectedStage && (
              <button 
                onClick={handleReset}
                className="flex items-center justify-center w-8 h-8 rounded-full bg-white/50 text-slate-600 hover:bg-white transition-colors"
              >
